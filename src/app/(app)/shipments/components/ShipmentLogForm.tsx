...
export function ShipmentLogForm({ log, onSuccess }: ShipmentLogFormProps) {
  ...
  const form = useForm<ShipmentLogFormValues>({
    ...
    defaultValues: log
      ? { ...log, date: new Date(log.date), notes: log.notes || "", customerOrderId: log.customerOrderId || "" }
      : {
          productId: "",
          quantity: 0,
          date: new Date(),
  ...
  function onSubmit(data: ShipmentLogFormValues) {
    try {
      const logDataSubmit = {
        ...
        customerOrderId: data.customerOrderId || undefined,
      };
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value} value={field.value || ""}>
                ...
                <SelectContent>
                  <SelectItem value="">Sipariş Yok</SelectItem>
